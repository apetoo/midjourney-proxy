...
///**
// * @author wanmingyu
// * @create 2023/6/10 12:14 下午
// */
//public class CosUploadUtils {
//
//    // 创建 TransferManager 实例，这个实例用来后续调用高级接口
//    public static TransferManager createTransferManager(String secretId, String secretKey) {
...
//    public static COSClient createCOSClient(String secretId, String secretKey) {
